...
This script loads data of a single L4 imaging volume of all mice, finds clusters and calculates ODI for clusters
...
parser = argparse.ArgumentParser( description = "This script loads data of a single L4 imaging volume of all mice, finds clusters and calculates ODI for clusters.\n (written by Pieter Goltstein - Dec 2024)")
...
# Save data
savefile = os.path.join(processeddatapath, add_suffix("cluster-odi-mice", args, ".npz") )
